...
#import "AvailableOffersVC.h"
#import "CurrentOfferCell.h"
#import "DefinesAndHeaders.h"

@interface AvailableOffersVC ()
{
    NSArray *dataArr;
    Singleton*singleton;
...
@implementation AvailableOffersVC
...
-(void)select:(UIButton*)btn
{
    ...
    NSArray *templateData = [dataArr objectAtIndex:indexPath.row];
    singleton.offername = [templateData valueForKey:@"couponcode"];
    NSLog(@"%@",templateData);
